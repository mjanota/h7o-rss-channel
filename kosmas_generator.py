...
class KosmasRSSGenerator:
    def __init__(self, base_url="https://www.kosmas.cz/novinky/", 
    ...
    def run(self):
        ...
        if is_first_run:
            print(f"První spuštění - stahuji novinky z prvních {self.max_pages} stránek...\n")
        ...
        if len(unique_items) > 200:
            sorted_by_date = sorted(unique_items, key=lambda x: x['date'], reverse=True)
