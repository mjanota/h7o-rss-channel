...
class H7oRSSGenerator:
    ...
    def fetch_all_articles(self, max_pages=20):
        ...
        while page_num <= max_pages:
            ...
            print(f"Nalezeno {len(new_articles)} relevantních článků (přeskočeno {old_count} starých).")
    ...
    def run(self):
        ...
        if is_first_run:
            ...
            new_articles = self.fetch_all_articles()
        else:
